...
public class Surround4Gamea {
     ...
     * @param playersArray
     */
    public Surround4Gamea(int qSize, int playerNumber, int choosePlayer, int[] playersArray) {
//    super();
        size = qSize;
    ...
    public void setCurrectPlayer(int newP)
    {
        playersArray[getCurrentPlayer()] = playersArray[newP];
    }
